...
foreach($_SESSION['cart'] as $id => $quantity):
	...
	mysql_query("INSERT INTO orders(name,s_name,address,post_index,email,prod,prod_id,price,qty,date,time) VALUES ('$name','$s_name','$address','$post_index','$email','$title','$iden','{$product['price']}','$quantity','$date','$time')") or die(mysql_error());
endforeach;
?>